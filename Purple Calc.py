...
root = Tk()
blank_space = " "
root.title (50 * blank_space + "Calculation")
...
entDisplay = Entry(MainFrame, font=('arial',18, 'bold'), bd=14, width=26,bg='purple', justify=RIGHT)
...
bg= 'purple', command= lambda:added_value.operation("add"))
btnAdd.grid(row=3, column=3, pady=1)

btnSub= Button(MainFrame, width=6, height=2, font=('arial',16, 'bold'), bd=4,text="-",
bg= 'purple', command= lambda:added_value.operation("sub"))
btnSub.grid(row=4, column=3, pady=1)

btnMult= Button(MainFrame, width=6, height=2, font=('arial',16, 'bold'), bd=4,text="*",
bg= 'purple', command= lambda:added_value.operation("multi"))
btnMult.grid(row=5, column=3, pady=1)

btnDiv= Button(MainFrame, width=6, height=2, font=('arial',16, 'bold'), bd=4,text="/",
bg= 'purple', command= lambda:added_value.operation("divide"))
